-- 0005: widen the event-kind enum with the custody verbs:
-- secret_exec (a command ran with a credential injected, its
-- output redacted) and secret_leakscan (the shelves were swept
-- for exposed secret bytes). Same rebuild dance as ever.
